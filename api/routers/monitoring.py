...
async def get_database_status(
    ...
    return {
        ...
        "performance": {"avg_query_time_ms": 12.5, "slow_queries": 0, "cache_hit_ratio": 0.95},
...
async def get_system_metrics(
    ...
    return {
        ...
        "memory": {"used_gb": 4.5, "total_gb": 16.0, "percent": 28.1},
        "disk": {"used_gb": 120.5, "total_gb": 500.0, "percent": 24.1},
        "network": {"bytes_sent": 1024000, "bytes_recv": 2048000, "connections": 42},
        "timestamp": datetime.now(timezone.utc).isoformat(),
    }
...
async def get_api_performance(
    ...
    return {
        ...
        "overall": {"avg_response_time_ms": 180, "requests_per_minute": 500, "error_rate": 0.015},
        "timestamp": datetime.now(timezone.utc).isoformat(),
    }
