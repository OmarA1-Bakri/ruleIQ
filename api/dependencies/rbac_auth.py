...
async def get_current_user_with_roles(
    token: Optional[str] = Depends(oauth2_scheme), async_db: AsyncSession = Depends(get_async_db)
...
def require_framework_access_level(framework_id: str, access_level: str = "read") -> Any:
    """
